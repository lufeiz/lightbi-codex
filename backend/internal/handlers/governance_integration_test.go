...
func validChartConfig() []byte {
	return []byte(`{"version":2,"widgets":[{"id":"w1","type":"metricCard","x":0,"y":0,"width":320,"height":180,"config":{"title":"收入","dimensions":["month"],"measures":["revenue"],"showLabel":true,"showTooltip":true,"showScrollbar":false}}]}`)
}
